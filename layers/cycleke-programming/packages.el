...
;; URL: https://github.com/cycleke/Spacemacs-config
;;
;; This file is not part of GNU Emacs.
;;
;;; License: GPLv3

(setq cycleke-programming-packages
      '(
        css-mode
        cmake-mode
        flycheck
...
(defun cycleke-programming/post-init-python ()
  (add-hook 'python-mode-hook #'(lambda () (modify-syntax-entry ?_ "w")))
  ;; if you use pyton3, then you could comment the following line
  (setq python-shell-interpreter "ipython"))

(defun cycleke-programming/post-init-web-mode ()
...
(defun cycleke-programming/post-init-yasnippet ()
  (progn
    ...
    (spacemacs/add-to-hooks 'cycleke/load-yasnippet '(prog-mode-hook
                                                            markdown-mode-hook
                                                            org-mode-hook))
    ))

(defun cycleke-programming/post-init-json-mode ()
...
(defun cycleke-programming/init-nodejs-repl ()
  (use-package nodejs-repl
    :init
    :defer t))

(defun cycleke-programming/init-flycheck-package ()
  (use-package flycheck-package))

(defun cycleke-programming/init-lispy ()
  (use-package lispy
    :defer t
    :init
    (progn
...
(defun cycleke-programming/init-cmake-font-lock ()
  (use-package cmake-font-lock
    :defer t))

(defun cycleke-programming/init-google-c-style ()
  (use-package google-c-style
    :init (add-hook 'c-mode-common-hook 'google-set-c-style)))

(defun cycleke-programming/post-init-cmake-mode ()
  (progn
...
(defun cycleke-programming/post-init-flycheck ()
...
(defun cycleke-programming/post-init-eldoc ()
  (setq eldoc-idle-delay 0.4))


(defun cycleke-programming/post-init-js2-refactor ()
  (progn
    (spacemacs/set-leader-keys-for-major-mode 'js2-mode
      "r>" 'js2r-forward-slurp
      "r<" 'js2r-forward-barf)))

(defun cycleke-programming/post-init-js2-mode ()
  (progn
...
(defun cycleke-programming/post-init-css-mode ()
  (progn
...
(defun cycleke-programming/post-init-tagedit ()
  (add-hook 'web-mode-hook (lambda () (tagedit-mode 1))))

;; For each extension, define a function cycleke/init-<extension-name>
;;
(defun cycleke-programming/init-doxymacs ()
  "Initialize doxymacs"
...
(defun cycleke-programming/init-nodejs-repl-eval ()
...
(defun cycleke-programming/post-init-lua-mode ()
  (progn
...
(defun cycleke-programming/post-init-cc-mode ()
  (progn
...
(defun cycleke-programming/init-flycheck-clojure ()
...
(defun cycleke-programming/init-etags-select ()
